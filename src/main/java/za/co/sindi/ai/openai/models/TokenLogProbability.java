 ...
 */
public class TokenLogProbability implements Serializable {
	...
	private TopTokenLogProbability[] topLogProbabilities;
	 ...
	 */
	public TokenLogProbability(String token, Double logProbability, byte[] bytes,
			TopTokenLogProbability[] topLogProbabilities) {
		super();
		this.token = token;
	 ...
	 */
	public TopTokenLogProbability[] getTopLogProbabilities() {
