 ...
 */
public class EmbeddingInputIntArrays extends EmbeddingInput<int[][]> {
	 ...
	 * 
	 */
	public EmbeddingInputIntArrays() {
		super();
	 ...
	 * @param model
	 */
	public EmbeddingInputIntArrays(int[][] input, Embeddings model) {
		super(model);
		// TODO Auto-generated constructor stub
